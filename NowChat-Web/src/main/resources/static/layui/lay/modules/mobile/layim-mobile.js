  ...
  var anim = 'layui-anim-upbit', events = { 
    ...
    ,face: function(othis, e){
      ...
      layui.each(faces, function(key, item){
         content += '<li title="'+ key +'"><img layui="'+ item +'"></li>';
      });
    ...
    ,playVideo: function(othis){
      ...
      events.playVideo.index = layer.open({
        ...
        ,content: '<div style="background-color: #000; height: 100%;"><video style="position: absolute; width: 100%; height: 100%;" layui="'+ videoData +'" autoplay="autoplay"></video></div>'
      });
    }
