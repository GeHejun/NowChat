...
// source: NowChat-Chat/src/main/java/com/ghj/chat/protocol/message.proto
...
public final class MessageProto {
  ...
  public interface messageOrBuilder extends
     ...
     * <code>.message.ClientBehavior clientBehavior = 10;</code>
     */
    MessageProto.message.ClientBehavior getClientBehavior();
     ...
     * <code>.message.MessageDirect messageDirect = 11;</code>
     */
    MessageProto.message.MessageDirect getMessageDirect();

    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    java.util.List<java.lang.Integer> getGroup2UserIdList();
    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    int getGroup2UserIdCount();
    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    int getGroup2UserId(int index);
  }
  /**
   * <pre>
   * class Person
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 96: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                group2UserId_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              group2UserId_.addInt(input.readInt32());
              break;
            }
            case 98: {
    ...
    public enum MessageDirect
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return MessageProto.message.getDescriptor().getEnumTypes().get(1);
      }
     ...
     * <code>.message.ClientBehavior clientBehavior = 10;</code>
     */
    public MessageProto.message.ClientBehavior getClientBehavior() {
      @SuppressWarnings("deprecation")
      MessageProto.message.ClientBehavior result = MessageProto.message.ClientBehavior.valueOf(clientBehavior_);
      return result == null ? MessageProto.message.ClientBehavior.UNRECOGNIZED : result;
    }
     ...
     * <code>.message.MessageDirect messageDirect = 11;</code>
     */
    public MessageProto.message.MessageDirect getMessageDirect() {
      @SuppressWarnings("deprecation")
      MessageProto.message.MessageDirect result = MessageProto.message.MessageDirect.valueOf(messageDirect_);
      return result == null ? MessageProto.message.MessageDirect.UNRECOGNIZED : result;
    }

    public static final int GROUP2USERID_FIELD_NUMBER = 12;
    private com.google.protobuf.Internal.IntList group2UserId_;
    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    public java.util.List<java.lang.Integer>
        getGroup2UserIdList() {
      return group2UserId_;
    }
    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    public int getGroup2UserIdCount() {
      return group2UserId_.size();
    }
    /**
     * <code>repeated int32 group2userId = 12;</code>
     */
    public int getGroup2UserId(int index) {
      return group2UserId_.getInt(index);
    }
    private int group2UserIdMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (clientBehavior_ != MessageProto.message.ClientBehavior.LOGIN.getNumber()) {
        output.writeEnum(10, clientBehavior_);
      }
      if (messageDirect_ != MessageProto.message.MessageDirect.PERSONAL.getNumber()) {
        output.writeEnum(11, messageDirect_);
      }
      if (getGroup2UserIdList().size() > 0) {
        output.writeUInt32NoTag(98);
        output.writeUInt32NoTag(group2UserIdMemoizedSerializedSize);
      }
      for (int i = 0; i < group2UserId_.size(); i++) {
        output.writeInt32NoTag(group2UserId_.getInt(i));
      }
      ...
      }
      {
        ...
        for (int i = 0; i < group2UserId_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(group2UserId_.getInt(i));
        }
        size += dataSize;
        if (!getGroup2UserIdList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        group2UserIdMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getGroup2UserIdList()
          .equals(other.getGroup2UserIdList())) return false;
    ...
    public int hashCode() {
      ...
      if (getGroup2UserIdCount() > 0) {
        hash = (37 * hash) + GROUP2USERID_FIELD_NUMBER;
        hash = (53 * hash) + getGroup2UserIdList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      // Construct using com.ghj.chat.protocol.MessageProto.message.newBuilder()
      private Builder() {
      ...
      public MessageProto.message buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          group2UserId_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.group2UserId_ = group2UserId_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(MessageProto.message other) {
        ...
        if (!other.group2UserId_.isEmpty()) {
          if (group2UserId_.isEmpty()) {
            group2UserId_ = other.group2UserId_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureGroup2UserIdIsMutable();
            group2UserId_.addAll(other.group2UserId_);
          }
          onChanged();
        }
  ...
  checkByteStringIsUtf8(value);
       ...
       * <code>.message.ClientBehavior clientBehavior = 10;</code>
       */
      public Builder setClientBehavior(MessageProto.message.ClientBehavior value) {
        if (value == null) {
          throw new NullPointerException();
        }
       ...
       * <code>.message.MessageDirect messageDirect = 11;</code>
       */
      public Builder setMessageDirect(MessageProto.message.MessageDirect value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.Internal.IntList group2UserId_ = emptyIntList();
      private void ensureGroup2UserIdIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          group2UserId_ = mutableCopy(group2UserId_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(group2UserId_) : group2UserId_;
      }
      /**
       * <code>repeated int32 group2userId = 12;</code>
       */
       ...
       * <code>repeated int32 group2userId = 12;</code>
       */
      public Builder setGroup2UserId(
          int index, int value) {
        ensureGroup2UserIdIsMutable();
        group2UserId_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated int32 group2userId = 12;</code>
       */
      public Builder addGroup2UserId(int value) {
        ensureGroup2UserIdIsMutable();
        group2UserId_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated int32 group2userId = 12;</code>
       */
      public Builder addAllGroup2UserId(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureGroup2UserIdIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, group2UserId_);
        onChanged();
        return this;
      }
      /**
       * <code>repeated int32 group2userId = 12;</code>
       */
      public Builder clearGroup2UserId() {
        group2UserId_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n>NowChat-Chat/src/main/java/com/ghj/cha" +
      "t/protocol/message.proto\"\231\003\n\007message\022\n\n\002" +
      ...
      "\016clientBehavior\030\n \001(\0162\027.message.ClientBe" +
      "havior\022-\n\rmessageDirect\030\013 \001(\0162\026.message." +
      "MessageDirect\022\024\n\014group2userId\030\014 \003(\005\"A\n\016C" +
      "lientBehavior\022\t\n\005LOGIN\020\000\022\010\n\004PING\020\001\022\013\n\007ME" +
      "SSAGE\020\002\022\r\n\tLOGIN_OUT\020\003\"4\n\rMessageDirect\022" +
      "\014\n\010PERSONAL\020\000\022\t\n\005GROUP\020\001\022\n\n\006SERVER\020\002B\'\n\027" +
      "com.ghj.common.protocolB\014MessageProtob\006p" +
      "roto3"
    };
    ...
    internal_static_message_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_message_descriptor,
        new java.lang.String[] { "Id", "LoginName", "NickName", "FromUserId", "ToUserId", "ToGroupId", "MessageTypeId", "Content", "Token", "ClientBehavior", "MessageDirect", "Group2UserId", });
  }
